...
extern "C" {
   ...
   color artist_color_rgb_u32(std::uint32_t rgb);
   color artist_color_rgba_u32(std::uint32_t rgba);
   color artist_color_rgb(std::uint8_t r, std::uint8_t g, std::uint8_t b);
   color artist_color_rgba(std::uint8_t r, std::uint8_t g, std::uint8_t b, std::uint8_t a);
