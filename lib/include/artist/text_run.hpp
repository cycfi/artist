...
=============================================================================*/
#if !defined(ARTIST_TEXT_RUN_MARCH_17_2020)
#define ARTIST_TEXT_RUN_MARCH_17_2020
...
namespace cycfi::artist
{
   ...
   // Inlines
   ////////////////////////////////////////////////////////////////////////////
   inline void text_run::draw(canvas& cnv, float x, float y, color c) const
   {
      draw(cnv, {x, y}, c);
   }

   inline std::size_t text_run::caret_index(float x, float y) const
   {
