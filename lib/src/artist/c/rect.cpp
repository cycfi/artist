...
extern "C" {
   ...
   bool     artist_rect_includes_pt(rect r, point p) { return r.includes(p); }
   bool     artist_rect_includes(rect r, rect const& other) { return r.includes(other); }
   ...
   rect     artist_rect_move(rect r, float dx, float dy) { return r.move(dx, dy); }
   rect     artist_rect_move_to(rect r, float x, float y) { return r.move_to(x, y); }
   rect     artist_rect_inset(rect r, float x_inset, float y_inset) { return r.inset(x_inset, y_inset); }
   rect     artist_rect_inset_square(rect r, float xy_inset) { return r.inset(xy_inset); }
