...
#
get_filename_component(filename "E:/source/repos/silovaa/artist/out/build/x64-Debug/lib/windows/msvc/x86_64/src/skia.zip" ABSOLUTE)
get_filename_component(directory "E:/source/repos/silovaa/artist/out/build/x64-Debug/lib/windows/msvc/x86_64/src/prebuilt_binaries" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-prebuilt_binaries${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-prebuilt_binaries${i}")
